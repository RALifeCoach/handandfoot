        ...
        function (cardArrays, playGame) {
            ...
            function addWildCardsToMeld(clickedMeld, scope) {
                ...
                if (clickedMeld.type === 'Clean Meld'
                    ...
                    var wilds = 0;
                    var cardIndex;
                    for (cardIndex = 0; cardIndex < clickedMeld.cards.length; cardIndex++) {
                        if (clickedMeld.cards[cardIndex].cardNumber > 0)
                            naturals++;
                        else
                            wilds++
                    }
                    if (clickedMeld.type !== 'Wild Card Meld' && wilds + cardArrays.wildCards.length >= naturals) {
                        ...
                        for (cardIndex = 0; cardIndex < cardArrays.wildCards.length; cardIndex++) {
