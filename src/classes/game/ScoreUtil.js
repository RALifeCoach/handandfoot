...
// build the stats
    static buildStats(gameData, direction, youResigned, theyResigned) {
        ...
        if (youResigned || yourScore < theirScore)
            status = "loss";
        else if (theyResigned || yourScore > theirScore)
            status = "win";
        else
            status = "tie";
