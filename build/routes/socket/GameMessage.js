...
var GameMessage = (function (_BaseSocketMessage) {
    _inherits(GameMessage, _BaseSocketMessage);

    function GameMessage(socket, playGame) {
        _classCallCheck(this, GameMessage);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(GameMessage).call(this, socket, playGame, 'gameMessage'));
    }
    ...
    _createClass(GameMessage, [{
        ...
        value: function onSocketMessage(data) {
            ...
            _get(Object.getPrototypeOf(GameMessage.prototype), 'onSocketMessage', this).call(this);
            ...
            this.connectedGame.sockets.forEach(function (connection) {
                ...
                _this2.sendMessage(connection, 'chatUpdate', {
                    chatText: text
                });
            });
        }
