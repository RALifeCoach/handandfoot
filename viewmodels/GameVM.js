        ...
        game.save(function (err, savedGame) {
            ...
            _this.mapToVM(game, function (err, gameVM) {
                ...
                if (game.gameComplete) {
                    _this.updatePlayers(gameVM, false, function () {
...
// end the game
GameVM.prototype.updateCards = function (playerVM, player, game, callback) {
    // update the hand and foot
    this.unloadCards(playerVM.handCards, player.handCards);
    this.unloadCards(playerVM.footCards, player.footCards);
